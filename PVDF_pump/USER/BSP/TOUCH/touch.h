...
#define EEPROM 0	
#define KEY_ADD (tp_dev.x>20&&tp_dev.x<60&&tp_dev.y>170&&tp_dev.y<210)
#define KEY_SUB (tp_dev.x>100&&tp_dev.x<140&&tp_dev.y>170&&tp_dev.y<210)
#define KEY_SWITCH (tp_dev.x>180&&tp_dev.x<220&&tp_dev.y>170&&tp_dev.y<210)
#define KEY_MODE (tp_dev.x>260&&tp_dev.x<300&&tp_dev.y>170&&tp_dev.y<210)
//触摸屏控制器
typedef struct
{
